...
public class LocalExecClientHandler
  ...
  /**
   * When closed, <br> If no messaged were received => NoMessage error is set to
   * future<br> Else if an error was
   * detected => Set the future to error (with or without exception)<br> Else if
   * no error occurs => Set success to the
   * future<br>
   */
  @Override
